...
#define RTB_STRUCTURE_NAME             ADCteste_B
#define RTP_STRUCTURE_NAME             ADCteste_P
...
static void rti_mdl_initialize_io_units(void)
{
  ...
  ds2202_dac_out(DS2202_1_BASE, DS2202_DAC_CH2, (Float32) (0/100.0));
  ds2202_dac_out(DS2202_1_BASE, DS2202_DAC_CH3, (Float32) (0/100.0));
  ds2202_dac_out(DS2202_1_BASE, DS2202_DAC_CH4, (Float32) (0/100.0));
