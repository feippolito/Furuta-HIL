/************************ dSPACE target specific file *************************
   ...
   Include file .\ADCteste_rti1006\ADCteste_th.c :

   Task Configuration file for model : ADCteste

   RTI1006 7.3 (02-Nov-2014)/2.6
   30-Oct-2018 21:53:03
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\ADCteste_rti1006\ADCteste_th.c is for ST).
# endif
