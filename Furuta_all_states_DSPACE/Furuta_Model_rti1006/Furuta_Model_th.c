/************************ dSPACE target specific file *************************
   ...
   Include file .\Furuta_Model_rti1006\Furuta_Model_th.c :

   Task Configuration file for model : Furuta_Model

   RTI1006 7.3 (02-Nov-2014)/2.6
   06-Nov-2018 13:55:40
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\Furuta_Model_rti1006\Furuta_Model_th.c is for ST).
# endif
