/*********************** dSPACE target specific file *************************
   ...
   Include file Furuta_Model_rti.c:
...
#define RTB_STRUCTURE_NAME             Furuta_Model_B
#define RTP_STRUCTURE_NAME             Furuta_Model_P
...
static void rti_mdl_initialize_io_boards(void)
{
  ...
  ds2202_timing_out_mode_set(DS2202_1_BASE, DS2202_PWMOUT_CH1,
    DS2202_TIMING_RANGE3, DS2202_D2PWM );
  ...
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN1, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN2, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN3, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN4, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN5, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN6, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN7, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN8, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN9, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN10, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN11, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN12, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN13, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN14, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN15, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN16, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN17, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN18, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN19, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN20, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN21, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN22, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN23, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN24, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN25_32, 2.5);
  ds2202_digin_threshold_set(DS2202_1_BASE, DS2202_THRESH_DIGIN33_38, 2.5);
  ...
  ds2202_timing_in_mode_set(DS2202_1_BASE, DS2202_PWMIN_CH1,
    DS2202_TIMING_RANGE3, DS2202_PWM2D);
  ds2202_timing_in_mode_set(DS2202_1_BASE, DS2202_PWMIN_CH2,
    DS2202_TIMING_RANGE3, DS2202_PWM2D);
}
...
__INLINE void rti_mdl_sample_input(void)
{
  ...
  /* dSPACE I/O Board DS2202 #1 Unit:BITIN */
  {
    UInt32 value_16 = 0;
    ds2202_bit_io_in(DS2202_1_BASE, DS2202_BITIO_IN_G1, &value_16 );
    Furuta_Model_B.SFunction1 = (boolean_T) ((value_16 & 1) >> 0);
  }

  /* dSPACE I/O Board DS2202 #1 Unit:PWM2D */
  ds2202_pwm_in(DS2202_1_BASE, DS2202_PWMIN_CH1, &Furuta_Model_B.SFunction1_o2,
                &Furuta_Model_B.SFunction1_o1);
  ds2202_pwm_in(DS2202_1_BASE, DS2202_PWMIN_CH2, &Furuta_Model_B.SFunction1_o2_c,
