g = 9.81;
kb = 6e-4; %valor original 6e-4
m1 = 0.1862;            %horizontal
m2 = 0.0391 + 0.0259;   %vertical
L1 = (51+44.55)*0.001;
L2 = 0.2983;
M = 0;
...
% Td = 0.02;
% model = ss(Ap,Bp,Cp,0);
% disc_model = c2d(model,Td,'tustin');
% p = exp([-7 -5 -3+3j -3-3j]*Td);
% 
% K_d = place(disc_model.A,disc_model.B,p);
