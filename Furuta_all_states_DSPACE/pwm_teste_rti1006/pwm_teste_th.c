/************************ dSPACE target specific file *************************
   ...
   Include file .\pwm_teste_rti1006\pwm_teste_th.c :

   Task Configuration file for model : pwm_teste

   RTI1006 7.3 (02-Nov-2014)/2.6
   26-Oct-2018 21:59:50
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\pwm_teste_rti1006\pwm_teste_th.c is for ST).
# endif
